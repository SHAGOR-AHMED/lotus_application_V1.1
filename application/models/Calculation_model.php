...
//======================================================//
	...
	public function get_expense(){
		...
		$result = $this->db->select('*')->from('tbl_collection_expense')->get()->result();
		return $result;
	}

	public function get_collectionExpenseFee(){

		$result = $this->db->select_sum('tbl_collection_expense.amount')->from('tbl_collection_expense')->get()->row();
		return $result;
	}
