				...
				<div class="widget-main">
					<div class="step-content pos-rel" id="step-container">
						<div class="step-pane active" id="step1">
							<form class="form-horizontal" action="<?php echo base_url('Expense/update_expense'); ?>" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<div class="clearfix">
											<input type="number" name="total_amount" class="col-xs-12 col-sm-4" required="required" value="<?= $selected_info->total_amount; ?>" placeholder="Enter Expense cost"/>
											&nbsp;&nbsp;<span class="fa fa-asterisk red"></span>
										</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<div class="clearfix">
											<input type="text" name="purpose" class="col-xs-12 col-sm-4" required="required" value="<?= $selected_info->purpose; ?>" placeholder="Purpose of expense"/>
											&nbsp;&nbsp;<span class="fa fa-asterisk red"></span>
										</div>
								...
								<input type="hidden" name="expense_id" class="col-xs-12 col-sm-4" required="required" value="<?= $selected_info->expense_id; ?>" />
