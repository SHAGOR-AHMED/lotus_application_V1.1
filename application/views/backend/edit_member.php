											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="row">
														<div class="col-xs-8 col-sm-11">
															<div class="input-group">
																<input type="number" name="reg_no" required="required" value="<?= $Member_List->reg_no;?>" />&nbsp;&nbsp;<span class="fa fa-asterisk red"></span>
															</div>
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="row">
														<div class="col-xs-8 col-sm-11">
															<div class="input-group">
																<textarea name="g_address" cols="25" rows="5" required="required" id="address"><?= $Member_List->g_address;?></textarea>&nbsp;&nbsp;<span class="fa fa-asterisk red"></span>
															</div>
															<div class="help-block"><?php echo form_error('g_address'); ?></div>
														</div>
													</div>

													<input type="hidden" name="mem_id" value="<?= $Member_List->mem_id;?>" />
