				...
				<div class="widget-main">
					<div class="step-content pos-rel" id="step-container">
						<div class="step-pane active" id="step1">
							<form name="member" class="form-horizontal" action="<?php echo base_url('Training/update_training'); ?>" method="post" enctype="multipart/form-data" onsubmit="return(validate());">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<div class="clearfix">
											<textarea name="remarks" cols="25" rows="5" required="required" class="col-xs-12 col-sm-4"><?= $selected_info->remarks; ?></textarea>&nbsp;&nbsp;<span class="fa fa-asterisk red"></span>
										</div>
										<div class="help-block"><?php echo form_error('remarks'); ?></div>
									</div>
								</div>

								<input type="hidden" name="training_id" class="col-xs-12 col-sm-4" required="required" value="<?= $selected_info->training_id; ?>" />
