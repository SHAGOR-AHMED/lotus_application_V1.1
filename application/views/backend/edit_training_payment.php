				...
				<div class="widget-main">
					<div class="step-content pos-rel" id="step-container">
						<div class="step-pane active" id="step1">
							<form name="member" class="form-horizontal" id="user-submit" action="<?php echo base_url('Training/update_training_fees'); ?>" method="post" enctype="multipart/form-data" autocomplete="off" onsubmit="return(validate());">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<div class="clearfix">
											<input type="text" name="total_amount" class="col-xs-12 col-sm-4" required="required" value="<?= $selected_info->total_amount; ?>" placeholder="Enter total payable Amount"/>
											&nbsp;&nbsp;<span class="fa fa-asterisk red"></span>
										</div>
									</div>
								</div>
								...
								<input type="hidden" name="trainingfees_id" value="<?= $selected_info->trainingfees_id; ?>" />
