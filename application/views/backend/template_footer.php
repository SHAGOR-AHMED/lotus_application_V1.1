				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">LOTUS</span>
		...
		<script src="<?php echo base_url()."assets/backend/js/custom-admin.js"; ?>"></script>
		<!-- <![endif]-->
		...
		<script src="<?php echo base_url()."assets/backend/js/flot/jquery.flot.pie.min.js"; ?>"></script>
		...
		<script src="<?php echo base_url()."assets/backend/js/jquery.dataTables.bootstrap.js"; ?>"></script>
		
		<!-- page specific plugin scripts -->
		<script src="<?php echo base_url()."assets/backend/js/fuelux/fuelux.wizard.min.js"; ?>"></script>
