...
<div class="row">
	<div class="col-xs-12">
		<div class="table-header">
			...
			All Daily Expense List
			<span class="add-new-record">
				<i class="fa fa-plus"></i>
				<a class="white" href="<?php echo base_url('Expense/create'); ?>">
					Add New Record
				</a>
			</span>
		</div>
				...
				<tbody>
					...
					?>
							<tr>
								...
								<td class="center">
									<a class="green" data-rel="tooltip" data-placement="bottom" title="Edit" href="<?php echo base_url('Expense/Edit_Expense/'.$val->expense_id); ?>">
